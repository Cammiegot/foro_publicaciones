...
def register():
    ...
    #Crear un diccionario que simule el form, incluyendo la contraseña
    form = {
...
def login():
    #request.form = {"e-mail": "elena@codingdojo.com", "password": "Hola123"}
    ...
    #user = User() , id=1, .first_name="Elena", .last_name="De Troya".... password="$326426gwyd2387kqd"
